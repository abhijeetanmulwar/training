...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrap">
				...
				<div class="row">
					<div class="col-md-6 d-flex align-items-center">
						<p class="mb-0 phone pl-md-2">
							<a href="#" class="mr-2"><span class="fa fa-phone mr-1"></span>8767264224</a> 
							<a href="#"><span class="fa fa-paper-plane mr-1"></span> abhijeetanmulwar@gmail.com</a>
						</p>
					</div>
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="index.html"><span class="flaticon-pawprint-1 mr-2"></span>Animal Care</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
          	<h1 class="mb-4">Care & Love In More Quantity For Your Pet's</h1>
    	...
    	<div class="container">
          ...
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services active text-center">
              ...
              <div class="media-body">
                ...
                <p>Your dog might wake up early due to a urinary tract infection, joint pain, or even due to dementia. If your dog frequently wakes up too early be sure to monitor them for signs of illness and distress. </p>
          ...
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
              ...
              <div class="media-body">
                <h3 class="heading">Medical Shop</h3>
                <p> We provide a best medical care for your pet from best pharmacist at your local areas. Our service is available 24/7</p>
                <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services text-center">
              ...
              <div class="media-body">
                ...
                <p>A variety of animal supplies and pet accessories are also sold in pet shops. The products sold include: food,treats,toys,collars,leashes and aquariusms.</p>
               <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
              </div>
            </div>      
          </div>
	            ...
	            <h2 class="mb-4">Why Choose Us?</h2>
    				...
    				<div class="row">
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					...
	    					<div class="text pl-3">
	    						<h4>Care Advices</h4>
	    						<p>The care advices from best Doctors and Pharmacist also from the Exprience people</p>
	    					</div>
	    				</div>
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					...
	    					<div class="text pl-3">
	    						...
	    						<p>Some costomer supports also has been suported by some experts.</p>
	    					</div>
	    				</div>
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					...
	    					<div class="text pl-3">
	    						...
	    						<p>Emergency Services provided by Medical Stores.</p>
	    					</div>
	    				</div>
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					...
	    					<div class="text pl-3">
	    						...
	    						<p>The veterinary Help aslo be provided.</p>
	    					</div>
	    				</div>
	    			</div>
	        </div>
    ...
    <section class="ftco-section bg-light ftco-faqs">
    	<div class="container">
    		<div class="row">
	            ...
	            <p>The questions that may helps you!</p>
    				</div>
    				<div id="accordion" class="myaccordion w-100" aria-multiselectable="true">
						  <div class="card">
						    ...
						    <div class="collapse show" id="collapseOne" role="tabpanel" aria-labelledby="headingOne">
						      <div class="card-body py-3 px-0">
						      	<ol>
						      		<li>It's good for their physicaland mental wellbeing</li>
						      		<li>You can spend some quality time together</li>
						      		<li>Trained puppies are well-behaved puppies</li>
						      	</ol>
						      </div>
						    </div>
						  </div>
						  ...
						  <div class="card">
						    ...
						    <div class="collapse" id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo">
						      <div class="card-body py-3 px-0">
						      	<ol>
						      		<li>Pets need healthy food.</li>
						      		<li>Give your pets 24/7 access to fresh drinking water.</li>
						      		<li>Proper pet care includes providing a safe, cozy shelter.</li>
						      		<li>Pets need to go to the bathroom regularly.</li>
						      		<li>Pets require doctor visits and healthy habits.</li>
						      	</ol>
						      </div>
						    </div>
						  </div>
						  ...
						  <div class="card">
						    ...
						    <div class="collapse" id="collapseThree" role="tabpanel" aria-labelledby="headingTwo">
						      <div class="card-body py-3 px-0">
						      	<ol>
						      		<li>Typically, a full-service dog grooming sessioncan take around three to four hours</li>
						      		<li> But it will depend on what services you are getting for your pooch and what size and breed it is.</li>
						      		<li> If you’re getting a minor service such as a nail trim or a quick bath, it may not take as long</li>
						      		<li> while a full haircut and style will take much longer.</li>
						      	</ol>
						      </div>
						    </div>
						  </div>
